import sys
sys.path.insert(0, "../../degradation")
from degradation import degrade
import numpy as np
import pdf2image

img = pdf2image.convert_from_path("./lease_agreement.pdf")

img[0].save('./lease_agreement.jpg')

degrade = degrade()

img = degrade.read("./lease_agreement.jpg")
...
degrade.save(newimg, "lease_agreement_latex_modified.jpg")
